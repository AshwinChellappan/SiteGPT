...
def get_user_intent(data:dict):
    ...
    "Identify user intent and respond with one word:
        ...
        -Safety advice or configure or high voltage or shock or calibrators or hazards or short circuit or floating: 'safe'
        -Competitor of Fluke related: 'competitors'
        -Policy or HR: 'hr'
        ...
        -Calibration or repair service: 'repair'
